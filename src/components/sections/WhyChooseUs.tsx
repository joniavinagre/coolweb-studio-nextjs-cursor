...
const features = [
  {
    ...
    description:
      "We build your site for mobile devices first, ensuring optimized code for a fast and responsive experience.",
  },
  {
  ...
  },
  {
    ...
    description:
      "If your site takes more than 3 seconds to load you lose up to 50% of your traffic. Our sites load in under 1.5 second.",
  },
  {
    title: "Fully Responsive",
    description:
      "Your website will fit all screens - mobile, tablet, and desktop — so visitors see your beautiful site no matter what.",
  },
  {
