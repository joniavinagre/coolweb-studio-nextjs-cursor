        ...
        >
          {services.map((service) => (
            ...
            >
              ...
              <Link
                to={service.href}
                className="inline-flex items-center justify-center px-4 py-2 rounded-full font-semibold text-xs uppercase tracking-wider btn-swipe-card mt-auto self-start"
              >
                Get Started
