  ...
  return <section className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          {services.map(service => <motion.div key={service.title} variants={item} className="group relative bg-card rounded-2xl p-8 border border-border flex flex-col h-full">
              {/* Icon */}
