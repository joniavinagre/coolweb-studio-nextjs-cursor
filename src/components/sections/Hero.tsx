        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.6
           ...
           <h1 className="text-5xl md:text-6xl text-primary-foreground uppercase tracking-wide leading-tight mb-6 font-extrabold lg:text-6xl">
            ...
            {/* Description */}
           <p className="font-body text-primary-foreground/70 text-xl leading-relaxed mb-8 max-w-lg md:text-base">
            ...
            {/* Trust indicators */}
            <div className="mt-12 flex flex-wrap gap-8 text-primary-foreground/60">
              <div className="flex items-center gap-2">
               ...
               <span className="text-base font-display">50+ Happy Clients</span>
              </div>
              <div className="flex items-center gap-2">
               ...
               <span className="text-base font-display">5.0 Rating</span>
              </div>
            </div>
          </motion.div>
