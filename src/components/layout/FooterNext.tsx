      ...
      <div className="container mx-auto px-4 py-16 pt-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <Link href="/">
              <img src="/assets/coolweb-logo-full.webp" alt="COOLWEB Studio" className="h-8 brightness-0 invert" />
            </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link href="/" className="text-primary-foreground hover:text-primary text-sm transition-colors">{t("header.home")}</Link>
              <Link href="/services" className="text-primary-foreground hover:text-primary text-sm transition-colors">{t("header.services")}</Link>
              <Link href="/portfolio" className="text-primary-foreground hover:text-primary text-sm transition-colors">{t("header.portfolio")}</Link>
              <Link href="/about" className="text-primary-foreground hover:text-primary text-sm transition-colors">{t("header.about")}</Link>
              <Link href="/contact" className="text-primary-foreground hover:text-primary text-sm transition-colors">{t("header.contact")}</Link>
            </div>
          </div>
