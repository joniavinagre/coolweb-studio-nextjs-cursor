...
export const projects: Project[] = [
  {
    ...
    aboutProject:
      "Gastón Molina needed a professional online presence that would reflect his expertise and 14+ years of experience in therapeutic massage. The website needed to convey trust, professionalism, and make it easy for potential clients to understand his services and book appointments.",
    challenges: [
    ...
    features: [
      {
        ...
        description:
          "Comprehensive showcase of massage therapies including chiromassage, sports massage, and specialized treatments",
      },
      {
        icon: Calendar,
  ...
  },
  {
    ...
    aboutProject:
      "4DHUES creates stunning handcrafted LED art panels that transform spaces with app-controlled RGB lighting. They needed an e-commerce platform that would showcase their innovative products while conveying the futuristic, tech-forward nature of their brand.",
    challenges: [
  ...
  },
  {
    ...
    aboutProject:
      "Dr. Vicente Briet is a renowned psychologist and sexologist with over 35 years of clinical experience. The website needed to convey professionalism and trust while handling sensitive topics with care, making it easy for patients to reach out confidentially.",
    challenges: [
  ...
  },
  {
    ...
    aboutProject:
      "Tropical Travel Agency offers unique organized tours and experiences throughout Spain and international destinations. They needed a vibrant website that would inspire wanderlust and make browsing and booking tours simple and enjoyable for customers.",
    challenges: [
  ...
  },
  {
    ...
    aboutProject:
      "Anabela is a talented nail artist in Marseille who provides personalized, one-on-one nail care services. Her website needed to reflect her personal touch and artistry while making it simple for clients to view her work and book appointments.",
    challenges: [
  ...
  },
  {
    ...
    aboutProject:
      "Savanah Weakly needed a captivating platform to launch her fantasy novel 'Quiver & Quill'. The website needed to immerse visitors in her fantasy world, introduce characters and lore, and enable pre-orders while building anticipation for the book release.",
    challenges: [
  ...
  },
  {
    ...
    aboutProject:
      "Ongles Fantaisies is a premium nail salon in Marseille offering comprehensive beauty services. They needed an elegant website that would showcase their diverse services while conveying the upscale, welcoming atmosphere of their salon.",
    challenges: [
    ...
    testimonial: {
      quote:
        "COOLWEB Studio created a stunning website that perfectly captures the elegance of our salon. Our online bookings have increased significantly!",
  ...
  },
  {
    ...
    aboutProject:
      "Mariline is a passionate Spanish teacher offering personalized online language instruction. Her website needed to convey her teaching approach, connect with potential students, and make it easy for them to learn about classes and get in touch.",
    challenges: [
    ...
    testimonial: {
      quote:
        "My online presence has completely transformed. The website makes it easy for students to learn about my classes and get in touch.",
      author: "Mariline",
  ...
  },
  {
    ...
    aboutProject:
      "Coffee & Bakery Marseille is a charming vintage coffee shop known for its cozy atmosphere and homemade offerings. The website needed to capture that warm, inviting feeling while showcasing their menu and making the location easy to find.",
    challenges: [
    ...
    testimonial: {
      quote:
        "The vintage aesthetic they created matches our cozy atmosphere perfectly. Customer engagement has never been better!",
      author: "Vanessa",
      role: "Owner",
    },
  },
  {
    ...
    aboutProject:
      "Tailang Ramen Restaurant needed a website that captures the essence of authentic Japanese ramen culture while presenting a modern dining experience.",
    challenges: [
    ...
    testimonial: {
      quote:
        "The website perfectly captures our restaurant's authentic atmosphere and has increased our online visibility.",
      author: "Tailang Team",
  ...
  },
  {
    ...
    aboutProject:
      "Raiz de Salud provides massage therapy and rehabilitation services focused on holistic wellness. They needed a calming, professional website to attract clients.",
    challenges: [
    ...
    features: [
      {
        icon: Heart,
        title: "Treatments",
        description: "Comprehensive overview of massage and rehabilitation services",
      },
  ...
  },
  {
    ...
    aboutProject:
      "Chico Diez Barber Club is a premium barbershop that needed a website matching their classic, masculine brand identity while making it easy for clients to book appointments.",
    challenges: [
